...
var mainState = function(game){
  ...
  this._overMenu = function() {
    ...
    adText.inputEnabled = true;
    adText.events.onInputDown.add(function() {
    ...
    // 悬停效果
    adText.events.onInputOver.add(function() {
      adText.fill = "#ff0";
    });
    adText.events.onInputOut.add(function() {
      adText.fill = "#fff";
    });
  };
  ...
  this.kgg = function() {
    ...
    var restartGame = function() {
      ...
      // 重置游戏状态
      this.items.val[1] = 3; // 重置生命值
      this.items.val[2] = 3; // 重置瞄准器
      this.items.txt[1].text = "3";
      this.items.txt[2].text = "3";
      ...
      holding = false;
      holdTime = 0;
    }.bind(this); // 确保 this 指向 mainState
