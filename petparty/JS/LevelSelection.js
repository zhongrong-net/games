...
Game.LevelSelection.prototype = {
    ...
    create : function(){
        ...
        console.log('获取生命',this.lifeCount);
        ...
        configObj.game.add.sprite(configObj.percentOfWidth(0.5), 2, "spriteAtlas", "Life1.png");//Life1.png
...
// Show custom modal
this.lifeCount = configObj.getLifeCount();
console.log('this.lifeCount', this.lifeCount);
// localStorage.setItem('livesCount', 1);
// 更新生命值文本（确保 this.lifeText 已初始化）
if (this.lifeText) {
    this.lifeText.text = "" + configObj.getLifeCount(); // Phaser 文本
    // 或者如果是 DOM 文本：
    // this.lifeText.textContent = "" + configObj.getLifeCount();
}

console.log('this.lifeText.text', this.lifeText ? this.lifeText.text : 'undefined', this.coinsText ? this.coinsText.text : 'undefined');
...
if (videoPlayer && restartButton) {
    videoPlayer.addEventListener('timeupdate', () => {
        ...
        if (restartButton) {
            restartButton.textContent = '增加爱心 ' + remainingTime + 's';
            if (remainingTime <= 0) {
...
if (videoPlayer && restartButton) {
    videoPlayer.addEventListener('ended', () => {
        if (restartButton) {
            ...
            restartButton.textContent = '增加爱心 0s';
        }
    });
}
...
if (restartButton) {
    restartButton.onclick = () => {
        ...
        console.log('this.lifeCount',this.lifeCount);
            ...
            configObj.localDataModelObj.incrementLife(5);
            if (this.lifeText) {
                this.lifeText.text = configObj.getLifeCount(); // 更新生命值文本
            }
            console.log('增加爱心', configObj.getLifeCount());
            ...
            // popUpContainer.add(configObj.game.add.text(configObj.percentOfWidth(0.23), 350, configObj.languageData["warning"]["noAttempts"].timerText, 
    ...
    gameTimer : function(){
        this.lifeCount  = configObj.getLifeCount();
        // console.log('获取时间',this.lifeCount);
